...
from .routers import auth_router, vms_router, dashboard_router, admin_router, sync_router, metrics_router, alarms_router, hosts_router, menu_permissions_router, keycloak_router, admin_vms_router, vm_control_router, reports_router
