-- ============================================================
-- Update Analytics Views to include additional VM data
-- IP Address, MAC Address, Storage Name, Project, CPU MHz
-- ============================================================

-- ============================================================
-- 1. VM Overview View (Current Status) - Updated with IP/MAC/Storage
-- ============================================================
...
-- ============================================================
CREATE OR REPLACE VIEW analytics.v_vm_detail AS
SELECT 
    vo.*,
